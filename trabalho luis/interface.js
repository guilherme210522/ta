...
function select(i, j) {
  ...
  if (select.obj_clicado === undefined || select.obj_clicado === null) {
    ...
    if (
      (peca.tipo == 1 && jogo.vez == 0) ||
      (peca.tipo == 0 && jogo.vez == 1)
    ) {
...
function atualizar_jogo() {
  const pecas = ["", "<img src='rei-branco.jpg' alt='♔'>", "<img src='rainha-branca.jpg' alt='♕'>", "<img src='torres-brancas.jpg' alt='♖'>", "<img src='bispos-brancos.jpg' alt='♗'>", "<img src='cavalos-bracos.jpg' alt='♘'>", "<img src='piões-brancos.jpg' alt='♙'>", "<img src='rei-preto.jpg' alt='♚'>", "<img src='rainha-preta.jpg' alt='♛'>", "<img src='torres-pretas.jpg' alt='♜'>", "<img src='bispos-pretos.jpg' alt='♝'>", "<img src='cavalos-pretos.jpg' alt='♞'>", "<img src='piões=pretos.jpg' alt='♟'>"];
  jogo.reiniciar();
